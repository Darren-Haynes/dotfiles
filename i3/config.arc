...
for_window [class="^Termite$"] normal pixel 5
for_window [class="^URxvt$"] normal pixel 5
for_window [class="^Code$"] border pixel 0
for_window [class="^Caja$"] normal pixel 5
for_window [class="^Evince$"] border pixel 0
for_window [class="^Rhythmbox$"] border pixel 0
for_window [class="^VirtualBox$"] border none
for_window [class="^cool-retro-term$"] border pixel 0
for_window [class="^Filezilla$"] border pixel 0
for_window [class="^Bitwarden$"] border pixel 0
for_window [class="^kdenlive$"] border pixel 0
for_window [class="^VirtualBox Manager$"] border pixel 0
for_window [class="^Transmission-gtk"] border pixel 0
for_window [class="^Clementine"] border pixel 0
for_window [class=".*"] title_format " %title"

# Applications default to floating
for_window [class="Pinentry"] floating enable
for_window [class="Pinentry"] border pixel 0
for_window [class="Gpick"] floating enable
for_window [class="^Gpick$"] border pixel 0
for_window [class="Thunar"] floating enable resize set 1900 1200
for_window [class="^Thunar$"] move left 180px, move down 175px
for_window [class="^Mate-calc$"] border pixel 0
for_window [class="^Gsimplecal$"] [floating] resize set 940 440
...
bindsym $mod+Ctrl+m exec gksudo /usr/bin/mullvad
bindsym $mod+Ctrl+v exec vlc
bindsym $mod+g exec gsimplecal

bindsym $mod+Ctrl+l exec ./home/darren/i3/lock.sh
bindsym $mod+Shift+d exec --no-startup-id rofi -show run
bindsym $mod+d exec --no-startup-id rofi -show drun -show-icons -drun-icon-theme Oranchelo-Classic-Folders
bindsym $mod+n exec networkmanager_dmenu -location 3

exec_always killall -q wallpaper-changer.sh
exec_always --no-startup-id feh --bg-scale /home/darren/dotfiles/wallpapers/solarizedbg_by_munsking-dakn6ts.png
...
#exec_always --no-startup-id ~/bin/wallpaper-changer.sh &
