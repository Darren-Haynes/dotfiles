...
source "$HOME/Dotfiles/install_scripts/ccat.sh"
...
# source "$HOME/Dotfiles/install_scripts/MS-Fonts.sh" # I dunno, only works when I do it twice
...
source "$HOME/Dotfiles/install_scripts/dunst.sh"
source "$HOME/Dotfiles/install_scripts/browsers.sh"
source "$HOME/Dotfiles/install_scripts/gtk_theme.sh"
source "$HOME/Dotfiles/install_scripts/neovim.sh"
source "$HOME/Dotfiles/install_scripts/neovim_after.sh"
source "$HOME/Dotfiles/install_scripts/tldr.sh"
source "$HOME/Dotfiles/install_scripts/rust.sh"
source "$HOME/Dotfiles/install_scripts/bluetui.sh"
